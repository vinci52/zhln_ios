...
- (void)setupViews
{
    ...
    */
    ...
    for (int i = 0; i < imageItems.count; i++) {
        ...
        [imageView setBackgroundImage:[UIImage imageNamed:@"placeholder_b"] forState:UIControlStateNormal];
        imageView.tag = i;
        [imageView sd_setBackgroundImageWithURL:[NSURL URLWithString:@"http://ttimg0.tuicool.com/11350072.png"]
...
//        imageView.image = item.image;
        //添加标题栏
        UILabel * lbltitle = [[UILabel alloc] initWithFrame:CGRectMake(i * _scrollView.frame.size.width+10, _scrollView.frame.size.height-32.0, _scrollView.frame.size.width, 22.0)];
